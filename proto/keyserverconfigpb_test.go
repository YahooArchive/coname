...
func TestEmailProofByCustomAuthProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedEmailProofByCustomAuth(popr, false)
	data, err := github_com_andres_erbsen_protobuf_proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	msg := &EmailProofByCustomAuth{}
	if err := github_com_andres_erbsen_protobuf_proto.Unmarshal(data, msg); err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
	littlefuzz := make([]byte, len(data))
...
func TestEmailProofByCustomAuthMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedEmailProofByCustomAuth(popr, false)
	size := p.Size()
...
func BenchmarkEmailProofByCustomAuthProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*EmailProofByCustomAuth, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedEmailProofByCustomAuth(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		data, err := github_com_andres_erbsen_protobuf_proto.Marshal(pops[i%10000])
...
func BenchmarkEmailProofByCustomAuthProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		data, err := github_com_andres_erbsen_protobuf_proto.Marshal(NewPopulatedEmailProofByCustomAuth(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = data
...
func TestEmailProofByCustomAuthJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedEmailProofByCustomAuth(popr, true)
	marshaler := github_com_andres_erbsen_protobuf_jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestEmailProofByCustomAuthProtoText(t *testing.T) {
	t.Skip()
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedEmailProofByCustomAuth(popr, true)
...
func TestEmailProofByCustomAuthProtoCompactText(t *testing.T) {
	t.Skip()
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedEmailProofByCustomAuth(popr, true)
...
func TestEmailProofByCustomAuthVerboseEqual(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedEmailProofByCustomAuth(popr, false)
	data, err := github_com_andres_erbsen_protobuf_proto.Marshal(p)
	if err != nil {
...
func TestEmailProofByCustomAuthGoString(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedEmailProofByCustomAuth(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestEmailProofByCustomAuthSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedEmailProofByCustomAuth(popr, true)
	size2 := github_com_andres_erbsen_protobuf_proto.Size(p)
...
func BenchmarkEmailProofByCustomAuthSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*EmailProofByCustomAuth, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedEmailProofByCustomAuth(popr, false)
	}
	b.ResetTimer()
...
func TestEmailProofByCustomAuthStringer(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedEmailProofByCustomAuth(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
